...
public class RecipeBookUIManager : MonoBehaviour
{
    ...
    public void UpdateLeftPageUI(Recipe recipe)
    {
        if (recipe == null)
        {
    ...
    public void UpdateRightPageUI(Recipe recipe)
    {
        if (recipe == null)
        {
    ...
    public void UpdateOnePageUI(Recipe recipe, TextMeshProUGUI recipeNameText, TextMeshProUGUI recipeDescriptionText, Transform ingredientPanel, Button makeRecipeButton)
    {
        ...
        foreach (RecipeIngredient recipeIngredient in recipe.ingredients)
        {
            ...
            text.text = $"{recipeIngredient.quantity} x {recipeIngredient.ingredientSO.ingredient.ToString()}";
        }
    }
}
